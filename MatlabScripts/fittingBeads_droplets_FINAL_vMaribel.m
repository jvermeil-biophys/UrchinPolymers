...
directory = 'D:\Maribel\Work\Leica\20250610_70%Yolk\20x_2fps_70%Yolk_14';
name = '20x_2fps_70%Yolk_14_Tracks.xml';                             %name of trajectory file
output_name = 'output_50%Yolk_m14-D8_11-17_re-check';                                     %name of output file
output_folder = '50%Yolk_m14-D8_11-17_re-check';                                          %name of output folder
cd(directory);

initPullFrame = 11;                                                %%% Previous frame to the magnet appear FROM FIJI MOVIE
finPullFrame = 17;                                                          %%% Final POSITION OF MAGNET FROM FIJI MOVIE
x_magnet = 112;                                                            %x magnet tip center in pixel                                                      
y_magnet = 1126;                                                        %y magnet tip center in pixel
