...
T = 21.99 				#temperature (degrees Celcius)
waterVol = 2.0 		#volume of water required (ml)
glycerolVol = 8.0	#volume of Glycerol used (ml)
...
RR = numpy.linspace(0, 1, num=21, endpoint=True)
